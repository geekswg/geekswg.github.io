...
const RENDERER = {
    ...
    FISH_COLOR: '#CC0000', //params.light || 'rgb(0 119 190 / 10%)';
    FISH_COLOR_LIGHT: 'rgb(0 119 190 / 10%)', //params.dark.light || 'rgb(0 119 190 / 10%)';
    FISH_COLOR_DARK: 'rgb(255 255 255 / 10%)', //params.dark || 'rgb(255 255 255 / 10%)';
    ...
    render: function () {
      ...
      function renderFrame() {
        ...
        if (fixit.isDark) {
          self.context.fillStyle = RENDERER.FISH_COLOR_DARK || 'rgb(255 255 255 / 10%)';
        } else {
          self.context.fillStyle = RENDERER.FISH_COLOR_LIGHT || 'rgb(0 119 190 / 10%)';
        }
  ...
  FISH.prototype = {
    ...
    render: function (context) {
      ...
      context.fillStyle = RENDERER.FISH_COLOR;
